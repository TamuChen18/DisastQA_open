    ...
    def generate_answer(self, query: str, context: List[str], options: List[str]) -> str:
        ...
        for attempt in range(max_retries):
            try:
                ...
                # 统一为0-shot prompt，添加格式引导词
                if context_str:
                    prompt = f"""Passage: {context_str}\n\nQuestion: {query}\nOptions:\n{options_str}\n\nPlease answer with the correct option (A/B/C/D) and briefly explain your reasoning.\n\nAnswer:"""
                else:
...
def main():
    ...
    base_dir = "/home/shared/RAG_DATA"
    test_sets = [
        f"{base_dir}/benchmark/MCQ/generated_test_sets/test_set_base_simple.json",
        f"{base_dir}/benchmark/MCQ/generated_test_sets/test_set_golden_simple.json",
        f"{base_dir}/benchmark/MCQ/generated_test_sets/test_set_mix_simple.json"
    ]
    ...
    for test_set in test_sets:
        ...
        output_path = f"{base_dir}/benchmark/testMCQ_set/{model_name}/{setting}_test.json"
